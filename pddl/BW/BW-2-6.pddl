(define
  ...
  (:constants
    ...
    $accept-1 $accept-0 $approve $reject-0-2 $assign-1 $reject-0-1 $refuse $reject-0-4 $assign-0 $reject-0-3 $reject-1-3 $reject-1-2 $reject-1-1 $reject-1-6 $reject-1-5 $reject-1-4 $reject-0-6 $reject-0-5 $end - Label
