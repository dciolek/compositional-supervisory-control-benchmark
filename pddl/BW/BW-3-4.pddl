(define
  ...
  (:constants
    ...
    $accept-1 $accept-0 $approve $accept-2 $assign-2 $reject-0-2 $assign-1 $reject-0-1 $refuse $reject-0-4 $assign-0 $reject-0-3 $reject-1-3 $reject-1-2 $reject-1-1 $reject-2-4 $reject-2-3 $reject-2-2 $reject-2-1 $reject-1-4 $end - Label
