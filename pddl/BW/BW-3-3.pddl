(define
  ...
  (:constants
    ...
    $accept-1 $accept-0 $approve $accept-2 $assign-2 $reject-0-2 $reject-0-1 $refuse $assign-1 $assign-0 $reject-0-3 $reject-1-3 $reject-1-2 $reject-1-1 $reject-2-3 $reject-2-2 $reject-2-1 - Label
