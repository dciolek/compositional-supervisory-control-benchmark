(define
  ...
  (:constants
    ...
    $accept-1 $accept-0 $reject-3-2 $approve $reject-3-3 $accept-3 $accept-2 $reject-3-1 $assign-2 $reject-0-2 $assign-1 $reject-0-1 $refuse $assign-0 $reject-0-3 $reject-1-3 $reject-1-2 $reject-1-1 $assign-3 $reject-2-3 $reject-2-2 $reject-2-1 - Label
