(define
  ...
  (:constants
    ...
    $-1 $0 $1 $2 $3 $4 $5 - State
    $accept-1 $reject-0-2 $assign-1 $refuse $reject-0-1 $accept-0 $approve $assign-0 $reject-1-2 $reject-1-1 - Label
  ...
  (:action do$accept-1
    ...
    :effect
      (and
        ...
        (when (at $1 $Crew-1)
          (and (not (at $1 $Crew-1)) (at $5 $Crew-1))
        )
        (when (at $3 $Crew-1)
          (and (not (at $3 $Crew-1)) (at $5 $Crew-1))
        )
      )
  )
  ...
  (:action do$refuse
    ...
    :effect
      (and
        ...
        (when (at $5 $Crew-1)
          (and (not (at $5 $Crew-1)) (at $0 $Crew-1))
        )
        (when (at $0 $Crew-0)
