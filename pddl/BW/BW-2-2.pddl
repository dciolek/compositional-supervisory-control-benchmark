(define
  ...
  (:constants
    ...
    $accept-1 $reject-0-2 $assign-1 $refuse $reject-0-1 $accept-0 $approve $assign-0 $reject-1-2 $reject-1-1 $end - Label
  ...
  (:action setReady
    ...
    :effect
      (and
        ...
        (when (at $0 $Document)
          (and
            (ready $reject-0-2 $Document)
            (ready $reject-1-2 $Document)
  ...
  (:action do$accept-1
    ...
    :effect
      (and
        ...
        (when (at $1 $Crew-1)
          (and (not (at $1 $Crew-1)) (at $6 $Crew-1))
        )
        (when (at $4 $Crew-1)
          (and (not (at $4 $Crew-1)) (at $6 $Crew-1))
        )
      )
  )
  ...
  (:action do$refuse
    ...
    :effect
      (and
        ...
        (when (at $6 $Crew-1)
          (and (not (at $6 $Crew-1)) (at $3 $Crew-1))
        )
        (when (at $0 $Crew-0)
