(define
  ...
  (:constants
    ...
    $accept-1 $accept-0 $accept-2 $reject-2-6 $reject-1-3 $reject-1-2 $reject-2-5 $reject-1-1 $reject-2-4 $reject-2-3 $reject-2-2 $reject-2-1 $reject-1-6 $reject-1-5 $reject-1-4 $approve $reject-0-2 $assign-2 $refuse $reject-0-1 $assign-1 $assign-0 $reject-0-4 $reject-0-3 $reject-0-6 $reject-0-5 - Label
