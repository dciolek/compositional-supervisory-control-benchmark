(define
  ...
  (:constants
    ...
    $-1 $0 $1 $2 $3 $4 - State
    $assign-2 $accept-1 $assign-1 $refuse $reject-0-1 $accept-0 $approve $assign-0 $reject-1-1 $accept-2 $reject-2-1 - Label
  ...
  (:action do$assign-2
    ...
    :effect
      (and
        ...
        (when (at $3 $Crew-2)
          (and (not (at $3 $Crew-2)) (at $-1 $Crew-2))
        )
      )
  )
  ...
  (:action do$approve
    ...
    :effect
      (and
        ...
        (when (at $4 $Document)
          (and (not (at $4 $Document)) (at $0 $Document))
        )
        (when (at $0 $Crew-1)
          (and (not (at $0 $Crew-1)) (at $-1 $Crew-1))
        )
  ...
  (:action do$accept-2
    ...
    :effect
      (and
        ...
        (when (at $1 $Crew-2)
          (and (not (at $1 $Crew-2)) (at $3 $Crew-2))
        )
      )
  )
