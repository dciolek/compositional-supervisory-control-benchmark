(define
  ...
  (:constants
    ...
    $cat-0-move-8 $cat-0-move-7 $cat-0-move-9 $mouse-0-move-5 $cat-0-move-3 $cat-0-move-4 $mouse-0-move-4 $cat-0-move-5 $mouse-0-move-3 $cat-0-move-6 $mouse-0-move-2 $mouse-0-move-1 $cat-0-move-10 $cat-0-move-0 $mouse-0-move-0 $cat-0-move-1 $cat-0-move-2 $mouse-0-move-6 $safe $mouse-0-move-7 $mouse-0-move-8 $mouse-0-move-9 $cat-turn $mouse-0-move-10 $mouse-turn - Label
