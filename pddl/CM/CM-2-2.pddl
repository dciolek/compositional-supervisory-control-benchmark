(define
  ...
  (:constants
    ...
    $safe $cat-turn $cat-1-move-4 $cat-1-move-1 $cat-1-move-0 $cat-1-move-3 $cat-1-move-2 $cat-0-move-3 $mouse-0-move-4 $mouse-1-move-0 $cat-0-move-4 $mouse-0-move-3 $mouse-1-move-1 $mouse-turn $mouse-0-move-2 $mouse-1-move-2 $mouse-0-move-1 $mouse-1-move-3 $mouse-0-move-0 $cat-0-move-0 $mouse-1-move-4 $cat-0-move-1 $cat-0-move-2 - Label
