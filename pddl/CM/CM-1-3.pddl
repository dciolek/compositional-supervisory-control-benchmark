(define
  ...
  (:constants
    ...
    $mouse-0-move-6 $safe $cat-turn $cat-0-move-3 $mouse-0-move-5 $cat-0-move-4 $mouse-0-move-4 $cat-0-move-5 $mouse-turn $mouse-0-move-3 $cat-0-move-6 $mouse-0-move-2 $mouse-0-move-1 $cat-0-move-0 $mouse-0-move-0 $cat-0-move-1 $cat-0-move-2 - Label
