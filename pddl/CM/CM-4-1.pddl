(define
  ...
  (:constants
    ...
    $cat-3-move-1 $cat-3-move-0 $cat-3-move-2 $mouse-2-move-2 $mouse-2-move-0 $mouse-2-move-1 $cat-2-move-0 $cat-2-move-2 $cat-2-move-1 $mouse-0-move-2 $mouse-0-move-1 $cat-0-move-0 $mouse-0-move-0 $cat-0-move-1 $end $cat-0-move-2 $cat-turn $cat-1-move-1 $cat-1-move-0 $cat-1-move-2 $mouse-3-move-0 $mouse-1-move-0 $mouse-turn $mouse-1-move-1 $mouse-1-move-2 $mouse-3-move-1 $mouse-3-move-2 - Label
