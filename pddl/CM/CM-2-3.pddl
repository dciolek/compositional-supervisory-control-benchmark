(define
  ...
  (:constants
    ...
    $mouse-0-move-5 $cat-0-move-3 $mouse-0-move-4 $cat-0-move-4 $mouse-0-move-3 $cat-0-move-5 $mouse-0-move-2 $cat-0-move-6 $mouse-0-move-1 $mouse-0-move-0 $cat-0-move-0 $cat-0-move-1 $cat-0-move-2 $mouse-0-move-6 $safe $cat-turn $cat-1-move-5 $cat-1-move-4 $cat-1-move-6 $cat-1-move-1 $cat-1-move-0 $cat-1-move-3 $cat-1-move-2 $mouse-1-move-0 $mouse-1-move-1 $mouse-turn $mouse-1-move-2 $mouse-1-move-3 $mouse-1-move-4 $mouse-1-move-5 $mouse-1-move-6 - Label
  ...
  (:action do$mouse-0-move-3
    ...
    :effect
      (and
        ...
        (when (at $11 $Mouse-0)
          (and (not (at $11 $Mouse-0)) (at $8 $Mouse-0))
        )
        (when (at $14 $Mouse-0)
  ...
  (:action do$mouse-0-move-1
    ...
    :effect
      (and
        ...
        (when (at $17 $Mouse-0)
          (and (not (at $17 $Mouse-0)) (at $15 $Mouse-0))
        )
        (when (at $20 $Mouse-0)
  ...
  (:action do$cat-0-move-1
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $16 $Mouse-0)
          (and (not (at $16 $Mouse-0)) (at $-1 $Mouse-0))
        )
        (when (at $2 $Cat-0)
  ...
  (:action do$mouse-0-move-6
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $1 $Mouse-0)
          (and (not (at $1 $Mouse-0)) (at $21 $Mouse-0))
        )
        (when (at $4 $Mouse-0)
