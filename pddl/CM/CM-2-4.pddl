(define
  ...
  (:constants
    ...
    $mouse-1-move-8 $mouse-1-move-7 $cat-0-move-8 $cat-0-move-7 $mouse-0-move-5 $cat-0-move-3 $mouse-0-move-4 $cat-0-move-4 $mouse-0-move-3 $cat-0-move-5 $mouse-0-move-2 $cat-0-move-6 $mouse-0-move-1 $mouse-0-move-0 $cat-0-move-0 $end $cat-0-move-1 $cat-0-move-2 $mouse-0-move-6 $mouse-0-move-7 $mouse-0-move-8 $cat-turn $cat-1-move-5 $cat-1-move-4 $cat-1-move-7 $cat-1-move-6 $cat-1-move-1 $cat-1-move-0 $cat-1-move-3 $cat-1-move-2 $cat-1-move-8 $mouse-1-move-0 $mouse-turn $mouse-1-move-1 $mouse-1-move-2 $mouse-1-move-3 $mouse-1-move-4 $mouse-1-move-5 $mouse-1-move-6 - Label
  ...
  (:action do$cat-0-move-5
    ...
    :effect
      (and
        ...
        (when (at $2 $Monitor)
          (and (not (at $2 $Monitor)) (at $7 $Monitor))
        )
        (when (at $3 $Monitor)
          (and (not (at $3 $Monitor)) (at $7 $Monitor))
        )
        (when (at $6 $Monitor)
