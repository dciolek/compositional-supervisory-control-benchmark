(define
  ...
  (:constants
    $HeightMonitor-1 $HeightMonitor-0 $RampMonitor $ResponseMonitor $Airplane-0 - LTS
    $-1 $0 $1 $2 $3 $4 $5 - State
    $control-all $approach-0 $land-0 $land-crash $requestLand-0 $descend-0-1 $extendFlight-0 $descend-0-0 - Label
