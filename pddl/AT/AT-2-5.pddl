(define
  ...
  (:constants
    $HeightMonitor-1 $Airplane-1 $HeightMonitor-2 $HeightMonitor-0 $HeightMonitor-4 $ResponseMonitor $RampMonitor $HeightMonitor-3 $Airplane-0 - LTS
    $-1 $0 $1 $2 $3 $4 $5 $6 $7 $8 - State
    $approach-1 $descend-0-2 $control-all $approach-0 $descend-0-3 $descend-0-4 $descend-1-2 $descend-1-1 $descend-1-4 $descend-1-3 $land-crash $extendFlight-0 $extendFlight-1 $air-crash-0 $air-crash-2 $air-crash-1 $land-1 $land-0 $requestLand-0 $requestLand-1 $descend-1-0 $air-crash-4 $air-crash-3 $descend-0-1 $descend-0-0 - Label
