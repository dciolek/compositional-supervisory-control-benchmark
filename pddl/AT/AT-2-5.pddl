(define
  ...
  (:constants
    ...
    $approach-1 $descend-0-2 $approach-0 $descend-0-3 $descend-0-4 $descend-1-2 $descend-1-1 $descend-1-4 $descend-1-3 $land-crash $air-crash-0 $air-crash-2 $air-crash-1 $land-1 $land-0 $requestLand-0 $requestLand-1 $descend-1-0 $air-crash-4 $air-crash-3 $end $descend-0-1 $descend-0-0 - Label
