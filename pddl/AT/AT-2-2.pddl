(define
  ...
  (:constants
    ...
    $-1 $0 $1 $2 $3 $4 $5 - State
    $approach-1 $approach-0 $descend-1-1 $land-crash $air-crash-0 $air-crash-1 $land-1 $land-0 $requestLand-0 $descend-1-0 $requestLand-1 $end $descend-0-1 $descend-0-0 - Label
