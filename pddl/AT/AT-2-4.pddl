(define
  ...
  (:constants
    $HeightMonitor-1 $HeightMonitor-2 $Airplane-1 $HeightMonitor-0 $RampMonitor $ResponseMonitor $HeightMonitor-3 $Airplane-0 - LTS
    $-1 $0 $1 $2 $3 $4 $5 $6 $7 - State
    $approach-1 $descend-0-2 $control-all $approach-0 $descend-0-3 $descend-1-2 $descend-1-1 $descend-1-3 $land-crash $extendFlight-0 $extendFlight-1 $air-crash-0 $air-crash-2 $air-crash-1 $land-1 $land-0 $requestLand-0 $requestLand-1 $descend-1-0 $air-crash-3 $descend-0-1 $descend-0-0 - Label
