(define
  ...
  (:constants
    ...
    $-1 $0 $1 $2 $3 $4 $5 $6 - State
    $reject $return-1 $return-0 $get-1 $accept $get-0 $end $put-1 - Label
  ...
  (:action setReady
    ...
    :effect
      (and
        ...
        (when (and (at $6 $Buffer-1) (marked $6 $Buffer-1))
          (hoop $Buffer-1)
        )
        ...
        (when (and (at $6 $Machine-0) (marked $6 $Machine-0))
          (hoop $Machine-0)
        )
  ...
  (:action loop
    ...
    :effect
      (and
        ...
        (when (at $6 $Buffer-1) (marked $6 $Buffer-1))
        ...
        (when (at $6 $Machine-0) (marked $6 $Machine-0))
  ...
  (:action do$return-1
    ...
    :effect
      (and
        ...
        (when (at $5 $Buffer-1)
          (and (not (at $5 $Buffer-1)) (at $6 $Buffer-1))
        )
        (when (at $6 $Buffer-1)
          (and (not (at $6 $Buffer-1)) (at $-1 $Buffer-1))
        )
        (when (at $1 $TU)
  ...
  (:action do$get-1
    ...
    :effect
      (and
        ...
        (when (at $6 $Buffer-1)
          (and (not (at $6 $Buffer-1)) (at $5 $Buffer-1))
        )
        (when (at $0 $TU)
  ...
  (:action do$get-0
    ...
    :effect
      (and
        ...
        (when (at $5 $Machine-0)
          (and (not (at $5 $Machine-0)) (at $6 $Machine-0))
        )
      )
  )
  ...
  (:action do$put-1
    ...
    :effect
      (and
        ...
        (when (at $6 $Machine-0)
          (and (not (at $6 $Machine-0)) (at $5 $Machine-0))
        )
      )
  )
)
