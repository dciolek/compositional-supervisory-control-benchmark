(define
  ...
  (:constants
    $Buffer-1 $Machine-5 $Machine-4 $Machine-3 $Buffer-5 $Machine-0 $Buffer-2 $Machine-1 $TU $Buffer-6 $Machine-2 $Buffer-3 $Buffer-4 - LTS
    $-1 $0 $1 $2 - State
    $return-5 $return-4 $get-6 $get-5 $return-3 $get-4 $return-2 $reject $get-3 $return-1 $get-2 $return-0 $get-1 $accept $get-0 $return-6 $put-4 $put-3 $put-6 $put-5 $put-2 $put-1 - Label
  ...
  (:action reset
    ...
    :effect
      (and
        ...
        (not (inprogress $return-6))
        (not (inprogress $put-4))
        (not (inprogress $put-3))
        (not (inprogress $put-6))
        ...
        (not (ready $get-5 $Machine-5))
        (not (ready $put-6 $Machine-5))
        ...
        (not (ready $accept $TU))
        (not (ready $return-6 $TU))
        (not (ready $get-6 $Buffer-6))
        (not (ready $put-6 $Buffer-6))
        (not (ready $return-6 $Buffer-6))
  ...
  (:action setReady
    ...
    :effect
      (and
        ...
        (when (at $0 $Machine-5)
          (ready $get-5 $Machine-5)
        )
        (when (at $1 $Machine-5)
          (ready $put-6 $Machine-5)
        )
        (when (at $0 $Machine-4)
        ...
        (when (at $0 $Buffer-6)
          (and
            (ready $get-6 $Buffer-6)
            (ready $return-6 $Buffer-6)
            (ready $put-6 $Buffer-6)
          )
        )
        (when (at $1 $Buffer-6)
          (and
        ...
        (when (and (at $0 $Machine-5) (marked $0 $Machine-5))
          (hoop $Machine-5)
        )
        (when (and (at $1 $Machine-5) (marked $1 $Machine-5))
          (hoop $Machine-5)
        )
        ...
        (when (and (at $-1 $Buffer-6) (marked $-1 $Buffer-6))
          (hoop $Buffer-6)
        )
        (when (and (at $0 $Buffer-6) (marked $0 $Buffer-6))
          (hoop $Buffer-6)
        )
        (when (and (at $1 $Buffer-6) (marked $1 $Buffer-6))
          (hoop $Buffer-6)
    ...
    :effect
      (and
        ...
        (oneof
          ...
          (when (enabled $return-6) (and (inprogress $return-6) (status uncontrollable)))
          ...
          (when (enabled $put-6) (and (inprogress $put-6) (status uncontrollable)))
  ...
  (:action loop
    ...
    :effect
      (and
        ...
        (when (at $1 $Buffer-1) (marked $1 $Buffer-1))
        (when (at $0 $Machine-5) (marked $0 $Machine-5))
        (when (at $1 $Machine-5) (marked $1 $Machine-5))
        ...
        (when (at $-1 $Buffer-6) (marked $-1 $Buffer-6))
        (when (at $0 $Buffer-6) (marked $0 $Buffer-6))
        (when (at $1 $Buffer-6) (marked $1 $Buffer-6))
  ...
  (:action do$return-5
    ...
    :effect
      (and
        ...
        (when (at $1 $Buffer-5)
          (and (not (at $1 $Buffer-5)) (at $-1 $Buffer-5))
        )
      )
  )
  ...
  (:action do$return-4
    ...
    :effect
      (and
        ...
        (when (at $1 $Buffer-4)
          (and (not (at $1 $Buffer-4)) (at $-1 $Buffer-4))
        )
      )
  )
  ...
  (:action do$get-6
    ...
    :effect
      (and
        ...
        (when (at $0 $Buffer-6)
          (and (not (at $0 $Buffer-6)) (at $-1 $Buffer-6))
        )
        (when (at $1 $Buffer-6)
          (and (not (at $1 $Buffer-6)) (at $0 $Buffer-6))
        )
      )
  )
  ...
  (:action do$get-5
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $0 $Machine-5)
          (and (not (at $0 $Machine-5)) (at $1 $Machine-5))
        )
        (when (at $0 $Buffer-5)
          (and (not (at $0 $Buffer-5)) (at $-1 $Buffer-5))
        )
  ...
  (:action do$return-3
    ...
    :effect
      (and
        ...
        (when (at $1 $Buffer-3)
          (and (not (at $1 $Buffer-3)) (at $-1 $Buffer-3))
        )
      )
  )
  ...
  (:action do$return-6
    ...
    :effect
      (and
        ...
        (when (at $1 $Buffer-6)
          (and (not (at $1 $Buffer-6)) (at $-1 $Buffer-6))
        )
      )
  )
  ...
  (:action do$put-6
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $1 $Machine-5)
          (and (not (at $1 $Machine-5)) (at $0 $Machine-5))
        )
        (when (at $0 $Buffer-6)
          (and (not (at $0 $Buffer-6)) (at $1 $Buffer-6))
        )
