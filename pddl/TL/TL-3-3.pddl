(define
  ...
  (:constants
    $Buffer-1 $Machine-0 $Machine-1 $Buffer-2 $TU $Machine-2 $Buffer-3 - LTS
    $-1 $0 $1 $2 $3 - State
    $return-3 $reject $return-2 $get-3 $return-1 $get-2 $return-0 $get-1 $accept $get-0 $put-3 $put-2 $put-1 - Label
  ...
  (:action do$return-3
    ...
    :effect
      (and
        ...
        (when (at $3 $Buffer-3)
          (and (not (at $3 $Buffer-3)) (at $-1 $Buffer-3))
        )
      )
  )
  ...
  (:action do$return-2
    ...
    :effect
      (and
        ...
        (when (at $3 $Buffer-2)
          (and (not (at $3 $Buffer-2)) (at $-1 $Buffer-2))
        )
      )
  )
  ...
  (:action do$return-1
    ...
    :effect
      (and
        ...
        (when (at $3 $Buffer-1)
          (and (not (at $3 $Buffer-1)) (at $-1 $Buffer-1))
        )
        (when (at $1 $TU)
