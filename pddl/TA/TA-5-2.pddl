  ...
  (:action do$steps-4-0
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $3 $Service-4)
          (and (not (at $3 $Service-4)) (at $11 $Service-4))
        )
      )
  )
  ...
  (:action do$committed-4
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $6 $Service-4)
          (and (not (at $6 $Service-4)) (at $9 $Service-4))
        )
      )
  )
  ...
  (:action do$query-succ-4
    ...
    :effect
      (and
        ...
        (when (at $11 $Service-4)
          (and (not (at $11 $Service-4)) (at $6 $Service-4))
        )
        (when (at $1 $ServiceMonitor-4)
