  ...
  (:action do$select-3
    ...
    :effect
      (and
        ...
        (when (at $12 $Service-3)
          (and (not (at $12 $Service-3)) (at $10 $Service-3))
        )
      )
  )
