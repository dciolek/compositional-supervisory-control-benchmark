(define
  ...
  (:constants
    ...
    $agency-request $query-fail-0 $unavailable-0 $agency-succ $query-0 $committed-0 $cancel-0 $purchase-0 $agency-fail $steps-0-3 $steps-0-4 $steps-0-1 $steps-0-2 $available-0 $steps-0-0 $select-0 $uncommitted-0 $query-succ-0 $purchase-fail-0 $purchase-succ-0 - Label
