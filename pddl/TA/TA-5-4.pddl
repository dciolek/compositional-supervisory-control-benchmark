  ...
  (:action do$committed-4
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $7 $Service-4)
          (and (not (at $7 $Service-4)) (at $10 $Service-4))
        )
      )
  )
  ...
  (:action do$query-succ-4
    ...
    :effect
      (and
        ...
        (when (at $13 $Service-4)
          (and (not (at $13 $Service-4)) (at $6 $Service-4))
        )
        (when (at $14 $Service-4)
          (and (not (at $14 $Service-4)) (at $7 $Service-4))
        )
        (when (at $1 $ServiceMonitor-4)
