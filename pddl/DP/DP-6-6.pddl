  ...
  (:action setReady
    ...
    :effect
      (and
        ...
        (when (and (at $12 $Philosopher-5) (marked $12 $Philosopher-5))
          (hoop $Philosopher-5)
        )
        ...
        (when (and (at $12 $Philosopher-4) (marked $12 $Philosopher-4))
          (hoop $Philosopher-4)
        )
        ...
        (when (and (at $12 $Philosopher-3) (marked $12 $Philosopher-3))
          (hoop $Philosopher-3)
        )
  ...
  (:action loop
    ...
    :effect
      (and
        ...
        (when (at $12 $Philosopher-5) (marked $12 $Philosopher-5))
        ...
        (when (at $12 $Philosopher-4) (marked $12 $Philosopher-4))
        ...
        (when (at $12 $Philosopher-3) (marked $12 $Philosopher-3))
  ...
  (:action do$end
    ...
    :effect
      (and
        ...
        (when (at $12 $Philosopher-5)
          (and (not (at $12 $Philosopher-5)) (at $0 $Philosopher-5))
        )
        (when (at $12 $Philosopher-1)
        ...
        (when (at $12 $Philosopher-4)
          (and (not (at $12 $Philosopher-4)) (at $0 $Philosopher-4))
        )
        (when (at $12 $Philosopher-3)
          (and (not (at $12 $Philosopher-3)) (at $0 $Philosopher-3))
        )
      )
  )
  ...
  (:action do$release-5-0
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $11 $Philosopher-5)
          (and (not (at $11 $Philosopher-5)) (at $12 $Philosopher-5))
        )
        (when (at $1 $Fork-0)
          (and (not (at $1 $Fork-0)) (at $0 $Fork-0))
        )
  ...
  (:action do$release-4-5
    ...
    :effect
      (and
        ...
        (when (at $11 $Philosopher-4)
          (and (not (at $11 $Philosopher-4)) (at $12 $Philosopher-4))
        )
      )
  )
  ...
  (:action do$release-3-4
    ...
    :effect
      (and
        ...
        (not (status busy))
        (when (at $11 $Philosopher-3)
          (and (not (at $11 $Philosopher-3)) (at $12 $Philosopher-3))
        )
        (when (at $1 $Fork-4)
          (and (not (at $1 $Fork-4)) (at $0 $Fork-4))
        )
